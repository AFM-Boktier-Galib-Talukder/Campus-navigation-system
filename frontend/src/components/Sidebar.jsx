    ...
    >
      ...
      <div className="h-32 text-center border-b border-green-200/30 flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-100/50 to-lime-100/50">
        <div className={`flex items-center justify-center transition-all duration-500 ease-in-out ${isExpanded ? "w-full" : "w-full justify-center"}`}>
          <div className="w-15 h-15 bg-gradient-to-br from-green-600 to-lime-400 rounded-2xl flex items-center justify-center text-white shadow-lg flex-shrink-0 p-2">
